...
def menu():
	...
	print (S + '[' + P + '☞3' + S + ']' + S + ' HASHIM MANDOKHAIL')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://github.com/ranamandokhail/Hashim')
	    ...
	    psb('WellCome Hashim Mandokhail')

	    psb('Congratulations Mandokhail Tool Has Been Updated Successfully')
	    ...
	    os.system('cd $HOME/hashim&& python2 hashim.py')
